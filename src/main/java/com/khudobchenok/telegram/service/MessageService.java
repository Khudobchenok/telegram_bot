...
public class MessageService {
    ...
    public Integer putUserMessage(User user, String message) throws IncorrectEmailException {
        ...
        if (messageList.size() >= 4) {
            emailService.sendMail(messageList.get(0), messageList.get(1), messageList.get(2), messageList.get(3));
